...
class ReviewModel extends BaseModel {
  ...
  public function getReviews($festival_id) {
    try {
      $sql    = 'SELECT user.user_id, user.user_name, review.festival_id, review.user_id, review.review, review.star, user.user_icon FROM user LEFT JOIN review ON user.user_id = review.user_id WHERE review.festival_id =?;';
