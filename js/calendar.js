...
function generate_calendar_header(wrapper, year, month) {
    ...
    // ヘッダー要素
    var cHeader = document.createElement('table');

  
    var cHeaderTr = document.createElement('tr');
    var cHeaderPrev = document.createElement('th');
    var cHeaderNext = document.createElement('th');
    var cHeaderTh = document.createElement('th');
    var cHeaderThText = document.createTextNode('');
    cHeaderTh.appendChild(cHeaderThText);
  
    // 見出しの追加
    var cTitle = document.createElement('th');
    var cTitleText = document.createTextNode(year + '/' + month);
    ...
    cHeaderPrev.appendChild(cPrev);
    cHeaderNext.appendChild(cNext);
  
    cHeaderTr.appendChild(cHeaderPrev);
    cHeaderTr.appendChild(cHeaderTh);
    cHeaderTr.appendChild(cHeaderTh);
    cHeaderTr.appendChild(cTitle);
    cHeaderTr.appendChild(cHeaderTh);
    cHeaderTr.appendChild(cHeaderTh);
    cHeaderTr.appendChild(cHeaderNext);
  
    cHeader.appendChild(cHeaderTr);
    return cHeader;
}
...
function generate_month_calendar(year, month) {
    ...
    for (var i = 0; i < calendarData.length; i++) {
        ...
        insertData += '<td class="day" onclick="clicked(this);">';
...
function clicked(day) {
  ...
  document.getElementsByClassName(day.className).style.border = 'solid 1px red';
};
